...
namespace GrosBrasInc.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArticleID,NomArticle,Description,Prix,CategorieID")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArticleID,NomArticle,Description,Prix,CategorieID")] Article article)
        {
            if (ModelState.IsValid)
            {
